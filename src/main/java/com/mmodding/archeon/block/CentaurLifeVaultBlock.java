...
import com.mmodding.archeon.block.entity.CentaurLifeVaultBlockEntity;
...
public class CentaurLifeVaultBlock extends BlockWithEntity {

	public static final EnumProperty<Lives> LIVES = EnumProperty.of("lives", Lives.class);

	public CentaurLifeVaultBlock(Settings settings) {
		super(settings);
