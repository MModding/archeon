...
import com.mmodding.library.block.api.catalog.SimpleSugarCaneBlock;
...
public class XetulianSugarCaneBlock extends SimpleSugarCaneBlock {

	public static final BooleanProperty HEAD = BooleanProperty.of("head");

	public XetulianSugarCaneBlock(@Nullable Predicate<BlockState> validFloor, @Nullable BiPredicate<BlockState, FluidState> validFluid, Settings settings) {
		super(validFloor, validFluid, settings);
