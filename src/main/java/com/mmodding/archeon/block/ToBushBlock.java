...
import com.mmodding.library.block.api.catalog.SimpleFernBlock;
...
public class ToBushBlock extends SimpleFernBlock {

	private final Supplier<Item> itemToLoot;

	public ToBushBlock(Supplier<Item> itemToLoot, Predicate<BlockState> placementConditions, Settings settings) {
	...
	public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
		...
		world.emitGameEvent(GameEvent.BLOCK_CHANGE, pos, GameEvent.Emitter.of(player, bushState));
