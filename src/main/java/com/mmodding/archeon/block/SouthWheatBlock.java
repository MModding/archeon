...
import com.mmodding.library.block.api.catalog.SimpleTallPlantBlock;
...
public class SouthWheatBlock extends SimpleTallPlantBlock implements Fertilizable {
	...
	public SouthWheatBlock(Predicate<BlockState> placementConditions, Settings settings) {
		super(placementConditions, settings);
	...
	public boolean hasRandomTicks(BlockState state) {
		return state.get(SimpleTallPlantBlock.HALF).equals(DoubleBlockHalf.LOWER) && !this.isMature(state);
	}
	...
	public void applyGrowth(World world, Random random, BlockPos pos, BlockState state, boolean head) {
	...
	public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
		this.applyGrowth(world, random, pos, state, state.get(SimpleTallPlantBlock.HALF).equals(DoubleBlockHalf.UPPER));
	}
