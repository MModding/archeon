...
import com.mmodding.archeon.client.entity.model.MourncreepEntityModel;
...
public class MourncreepEntityRenderer extends BipedEntityRenderer<MourncreepEntity, MourncreepEntityModel> {
	...
	public Identifier getTexture(MourncreepEntity entity) {
		return switch (entity.getVariant()) {
			case BLUE_RAGS -> new TextureLocation(Archeon.namespace(), "entity/mourncreep/blue_rags");
			case BROWN_RAGS -> new TextureLocation(Archeon.namespace(), "entity/mourncreep/brown_rags");
			case GREEN_RAGS -> new TextureLocation(Archeon.namespace(), "entity/mourncreep/green_rags");
			case YELLOW_RAGS -> new TextureLocation(Archeon.namespace(), "entity/mourncreep/yellow_rags");
		};
	}
}
