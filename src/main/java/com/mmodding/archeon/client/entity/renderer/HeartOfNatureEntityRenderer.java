...
import com.mmodding.archeon.client.entity.model.HeartOfNatureEntityModel;
...
public class HeartOfNatureEntityRenderer extends MobEntityRenderer<HeartOfNatureEntity, HeartOfNatureEntityModel> {
	...
	public Identifier getTexture(HeartOfNatureEntity entity) {
		return switch (entity.getPhase()) {
			case PETRIFIED -> new TextureLocation(Archeon.namespace(), "entity/heart_of_nature/petrified_heart_of_nature");
			case NORMAL -> new TextureLocation(Archeon.namespace(), "entity/heart_of_nature/heart_of_nature");
			case POISONOUS -> new TextureLocation(Archeon.namespace(), "entity/heart_of_nature/poisonous_heart_of_nature");
			case EXPLOSIVE -> new TextureLocation(Archeon.namespace(), "entity/heart_of_nature/explosive_heart_of_nature");
			case DEFEATED -> new TextureLocation(Archeon.namespace(), "entity/heart_of_nature/defeated_heart_of_nature");
		};
	}
	...
	public static class HeartOfNatureShieldFeatureRenderer extends EnergySwirlOverlayFeatureRenderer<HeartOfNatureEntity, HeartOfNatureEntityModel> {
		...
		protected Identifier getEnergySwirlTexture() {
			return new TextureLocation(Archeon.namespace(), "entity/heart_of_nature/heart_of_nature_shield");
		}
