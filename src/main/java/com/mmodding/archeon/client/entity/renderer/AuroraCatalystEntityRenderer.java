...
import com.mmodding.archeon.client.entity.model.AuroraCatalystEntityModel;
...
public class AuroraCatalystEntityRenderer extends MobEntityRenderer<AuroraCatalystEntity, AuroraCatalystEntityModel> {
	...
	public Identifier getTexture(AuroraCatalystEntity entity) {
		return switch (this.type) {
			case NORMAL -> new TextureLocation(Archeon.namespace(), "entity/aurora_catalyst");
			case POISONOUS -> new TextureLocation(Archeon.namespace(), "entity/poisonous_aurora_catalyst");
			case EXPLOSIVE -> new TextureLocation(Archeon.namespace(), "entity/explosive_aurora_catalyst");
		};
	}
