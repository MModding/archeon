...
public class SouthstoneColumnBlock extends CustomPillarBlock implements Waterloggable {

	public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

	public SouthstoneColumnBlock(Settings settings) {
		this(settings, false);
	}

	public SouthstoneColumnBlock(Settings settings, boolean hasItem) {
		this(settings, hasItem, (ItemGroup) null);
	}

	public SouthstoneColumnBlock(Settings settings, boolean hasItem, ItemGroup itemGroup) {
		this(settings, hasItem, itemGroup != null ? new QuiltItemSettings().group(itemGroup) : new QuiltItemSettings());
	}

	public SouthstoneColumnBlock(Settings settings, boolean hasItem, Item.Settings itemSettings) {
