...
import fr.firstmegagame4.archeon.client.entities.animations.CentaurEntityAnimations;
...
public class CentaurEntityModel extends SinglePartEntityModel<CentaurEntity> {
	...
	public void setAngles(CentaurEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
		...
		if (AnimationUtils.isMoving(entity, limbDistance)) {
			AnimationUtils.updateAnimation(this, CentaurEntityAnimations.GALLOPING, entity.galloping, animationProgress, 2.0f);
		}
	}
